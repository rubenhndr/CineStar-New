    ...
    <section class="hero" style="min-height: 80vh; padding-top: 100px;">
        <div class="hero-content" style="max-width: 500px;">
            ...
            <form method="POST" action="register.php">
                ...
                <button type="submit" class="btn">Daftar <i class="fas fa-user-plus"></i></button>
            </form>
            
            <p style="margin-top: 1.5rem;">Sudah punya akun? <a href="login.php" style="color: var(--secondary);">Login disini</a></p>
        </div>
    </section>
